...
class SimulationEndGame{
  ...
  //Player Opponent;
    ...
    public:
    SimulationEndGame(MoveGenerator MovGen,Board board)
    {
    ...
    Move* LookAhead(int Depth,int turn,Rack MyRack,Rack OppRack,Board CurrBoard,int ScoreRedArmy,int ScoreOpp, EndgameEvaluator* Eval)
    {
