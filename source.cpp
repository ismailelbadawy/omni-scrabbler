...
int main(){
	...
	board.Probe('c',7,5,3);		//Inserting letters 'e' and 't' to the empty board
	board.Probe('a',7,6,1);
	board.Probe('t',7,7,1);
	// board.Probe('a',7,5,1);
	// board.Probe('s',7,6,1);
